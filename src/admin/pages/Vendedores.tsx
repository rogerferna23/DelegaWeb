                  ...
                  <td className="px-4 py-3">
                    {confirmDelete === v.id ? (
                      <div className="flex items-center gap-1.5">
                        <button onClick={() => handleDelete(v.id)} className="bg-red-500/10 hover:bg-red-500/20 text-red-400 text-[9px] px-2 py-1 rounded-md transition-all border border-red-500/10">
                          Sí, eliminar
                        </button>
                        <button onClick={() => setConfirmDelete(null)} className="bg-white/5 hover:bg-white/10 text-gray-400 text-[9px] px-2 py-1 rounded-md transition-all border border-white/5">
                          No
                        </button>
                      </div>
                    ) : (
