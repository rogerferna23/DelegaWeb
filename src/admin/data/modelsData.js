// ============================================================
// modelsData.js — Datos estáticos para la sección Creativos con IA
// ============================================================
...
export const DEMO_ACTIVITY = [
  {
    id: 'act-1',
    name: 'Sneakers Hero V2',
    model: 'Flux 2 Pro',
    timeAgo: 'hace 35d',
    thumb: '/demo/sneakers-hero.webp',
    thumbGradient: 'from-red-600 to-red-900',
  },
  {
    id: 'act-2',
    name: 'Ad Black Friday',
    model: 'Recraft V3',
    timeAgo: 'hace 35d',
    thumb: '/demo/ad-black-friday.webp',
    thumbGradient: 'from-amber-700 to-amber-950',
  },
  {
    id: 'act-3',
    name: 'UGC Crema Facial',
    model: 'Seedream 4.5',
    timeAgo: 'hace 35d',
    thumb: '/demo/ugc-crema.webp',
    thumbGradient: 'from-pink-500 to-pink-900',
  },
  {
    id: 'act-4',
    name: 'Spot Cinemático Café',
    model: 'Veo 3.1',
    timeAgo: 'hace 35d',
    thumb: '/demo/spot-cafe.webp',
    thumbGradient: 'from-violet-600 to-violet-950',
  },
  {
    id: 'act-5',
    name: 'Reels Bebida',
    ...
    timeAgo: 'hace 35d',
    thumb: '/demo/reels-bebida.webp',
    thumbGradient: 'from-rose-500 to-rose-900',
  },
];
