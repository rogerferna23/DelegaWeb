...
import { useAuth, type MFAFactor, type MFAEnrollResult } from '../../contexts/AuthContext';
import {
...
function Step({ num, label, active, done }: { num: string | number; label: string; active: boolean; done: boolean }) {
  return (
