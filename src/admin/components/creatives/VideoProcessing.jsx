...
import { 
  Video, Loader2, Play, Download, Save, 
  CheckCircle2, AlertCircle, Clock, ArrowRight,
  TrendingUp, Sparkles, RefreshCw
} from 'lucide-react';
import { supabase } from '../../../lib/supabase';

export default function VideoProcessing({ videoId, runwayProjectId, onBack }) {
  ...
  useEffect(() => {
    ...
    if (status === 'processing') {
      intervalId = setInterval(checkStatus, 10000); // Polling cada 10s
    }
