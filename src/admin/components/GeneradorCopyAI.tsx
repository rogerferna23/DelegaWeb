...
interface CopyVariation { framework: string; primary_text: string; headline: string; description: string; cta: string }
interface CopyContext { offer?: string; client?: string; diff?: string; price?: string }

export default function GeneradorCopyAI({ onSelectCopy, context }: { onSelectCopy?: (v: CopyVariation) => void; context?: CopyContext }) {
  ...
  const results = (copyJob.result as CopyVariation[] | null) || null;
