...
export const VideoResultView = ({ data }) => {
...
export const CarouselResultView = ({ data }) => {
...
export const OptimizacionResultView = ({ data }) => {
  // Check if it's a carrusel or video logic inside based on key
  ...
  return (
    <div className="space-y-8 animate-fade-in text-white">
      ...
      <div className="border-t border-white/10 pt-4">
        ...
        {/* Usar los views existentes según el tipo de data */}
        {isCarrusel ? (
          <CarouselResultView data={contentData} />
        ) : (
          <VideoResultView data={contentData} />
        )}
      </div>
    </div>
  );
