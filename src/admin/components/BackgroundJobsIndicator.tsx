...
import { useBackgroundJobs, type Job, type JobStatus } from '../../contexts/BackgroundJobsContext';
...
export default function BackgroundJobsIndicator() {
  ...
  interface Toast { id: string; key: string; label: string; status: JobStatus; error?: string }
  ...
  const dismissToast = (id: string, key: string) => {
...
function JobRow({ job, onClear, onDismiss }: { job: Job; onClear?: () => void; onDismiss?: () => void }) {
