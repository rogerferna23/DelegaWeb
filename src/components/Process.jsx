  ...
  const steps = [
    {
      ...
      description: "Entendemos tus objetivos, tu público y tu competencia."
    },
    {
      num: "02",
      title: "Diseñamos tu estrategia",
      description: "Creamos un plan digital a medida para tu marca."
    },
    {
      num: "03",
      title: "Creamos tu web o campaña",
      description: "Desarrollamos con las mejores tecnologías del mercado."
    },
    {
      num: "04",
      title: "Optimizamos para resultados",
      description: "Medimos, ajustamos y mejoramos continuamente."
    },
    {
      num: "05",
      title: "Escalamos tu crecimiento",
      description: "Ampliamos tu presencia digital según tus resultados."
    }
  ];
  ...
  return (
    <section id="proceso" className="w-full py-16 max-w-4xl mx-auto">
      ...
      <div className="relative">
        ...
        <div className="absolute left-1/2 top-0 bottom-0 w-px bg-gray-800/80 -translate-x-1/2 md:block hidden"></div>
        ...
        <div className="flex flex-col gap-12">
          {steps.map((step, index) => (
            <div key={index} className={`relative flex flex-col md:flex-row items-center ${index % 2 === 0 ? 'md:justify-start' : 'md:justify-end'}`}>
              ...
              {/* Punto indicador */}
              <div className="absolute left-1/2 -translate-x-1/2 w-2.5 h-2.5 rounded-full bg-primary hidden md:block"></div>
