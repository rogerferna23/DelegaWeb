      ...
      <div className="bg-cardbg border border-gray-800 rounded-3xl p-4 md:p-6 text-center transform transition-all hover:border-gray-700 overflow-hidden">
        ...
        <div className="flex flex-col items-center gap-4 py-4">
          <a 
            ...
            className="inline-flex items-center gap-3 bg-green-600 hover:bg-green-500 text-white px-10 py-5 rounded-2xl font-bold transition-all transform hover:scale-105 shadow-xl shadow-green-900/20 text-xl"
          >
          ...
          <span className="text-xs text-gray-500 italic">Respuesta inmediata por WhatsApp</span>
        </div>
      </div>
    </section>
  );
